...
-   **הצטיינות בשיווק ופירסום המשחק באינטרנט**: שלושת הצוותים השמשחק שלהם יזכה בדירוג הגבוה ביותר    באתר `itch.io` ארבעה שבועות לאחר סיום הסמסטר (כ"ט בשבט ה'תשפ"א עם השקיעה) - יזכו במענק נקודות של 10 (ראשון), 5 (שני), 3 (שלישי).
...
שפיתח אותו אלא גם אנשים נוספים. לכן בקורס זה מותר לעבוד בצוותים של עד **ארבעה** סטודנטים.
